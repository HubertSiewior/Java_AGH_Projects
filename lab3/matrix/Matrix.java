...
public  class Matrix<T> implements Iterable<T> {
    ...
    public static Matrix<Integer> add(Matrix<Integer> m1, Matrix<Integer> m2) throws Exception {
        if (m1.getRows() != m2.getRows() || m1.getColumns() != m2.getColumns()) throw new Exception("Rzad macierzy sie nie zgadza ");
    ...
    public static Matrix<String> addString(Matrix<String> m1, Matrix<String> m2) throws Exception {
        if (m1.getRows() != m2.getRows() || m1.getColumns() != m2.getColumns()) throw new Exception("Rzad macierzy sie nie zgadza   ");
